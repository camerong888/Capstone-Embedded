...
// Sets the outputs want to recieve
void IMU::setReports()
{
    DPRINTLN("Setting desired reports");
    DPRINTLN("Setting desired reports");
...
void IMU::getSensorEvent(sh2_SensorValue_t &sensorValue)
{
...
void IMU::printActivity(uint8_t activity_id)
{
    switch (activity_id)
    {
    case PAC_UNKNOWN:
